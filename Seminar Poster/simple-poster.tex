...
\raggedright
 Expected learning rates when the visual feedback \textbf{is false}. Learning = move correct finger.
    ...
    \mbox{}\\
    \begin{itemize}
        \item uninhibitedly (\textcolor{MyGray}{\textbf{resilient}}),
        \item slower (\textcolor{MyBlueLight}{\textbf{hinderance}}),
        \item not at all (\textcolor{MyBlueDark}{\textbf{overwrite}}).
...
%	Block
%
\block[titleleft,roundedcorners=16]{7. Neural Correlate and Learning}{
\raggedright
    \includegraphics[width=\linewidth]{Figures/learning-curve.pdf}
    \textbf{Learning} is shown as mean performance over all ten fingers.    
    \includegraphics[width=\linewidth]{Seminar Poster/Figures/eba-activation.pdf}
    \textbf{EBA} activation refers to sense congruence and does \textbf{not} differ between learning rules. \\
    \mbox{} \\
    Update rule adapted from \textit{Rescorla/Wagner model}\\
    $V_{t+1}(s_t)=V_{t}(s_t) + \alpha * \delta_t.$ \\
    \mbox{} \\

    The models $\alpha$ \textbf{learning rate} differs for the three expected rules per finger:
    \begin{itemize}
        \item \textcolor{MyGray}{\textbf{resilient}}: $\alpha = 1 / 10 = .1$
        \item \textcolor{MyBlueLight}{\textbf{hinderance}}: $\alpha = .5 / 10 = .05$
        \item \textcolor{MyBlueDark}{\textbf{overwrite}} : $\alpha = 0$
    \end{itemize}    
}
%....................................................................................
%
...
\begin{itemize}
    \item \textbf{H1}: Congruence effects task performance (learning).            
