...
\block[titleleft,roundedcorners=16]{4. Experimental Design}{
 ...
 manipulation step: false finger moved (experimental trial) 
 vs correct finger moved (control trial)
false: participants movement not equal to 
 observed movement (vision and proprioception incongruence)
true:  participants movement equal to 
observed movement (vision and proprioception incongruence)
}
%....................................................................................
%
...
\block[titleleft,roundedcorners=16]{5. Region of Interests}{
	\begin{minipage}{0.5\linewidth}
	    ...
	    \textbf{Extrastriate Body Area}: Congruent versus incongruent visual and proprioceptive information. \\
            \mbox{} \\
            \textbf{Dorsolateral Prefrontal Cortex}: Activated in early learning processes. Shift from automatic to cognitive control. State: Consciously (implicitly) learning. \\
            \mbox{} \\
...
%	Block
%
\block[titleleft,roundedcorners=16]{6. Expected Learning Models}{
...
\block[titleleft,roundedcorners=16]{7. Neural Correlates and Learning}{
    ...
    The models differ in its $learning\:rate$.
