...
\block[titleleft,roundedcorners=16]{7. Neural Correlates and Learning}{
    ...
    \textbf{Learning} is shown as mean performance over all ten fingers. \textbf{EBA} activation refers to sense congruence and does \textbf{not} differ between learning rules.
    ...
    The models $learning\:rate$ differs for the three expected outcomes per finger:
    \begin{itemize}
...
\raggedright
Results show how \textbf{strong} false feedback from vision can \textbf{impede} or even \textbf{block} sensorimotor based learningCongruenc
}
